<?php
  session_start();
  if (isset($_SESSION['logInSeccessful'])){
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto" style="margin-left: auto;">
          ...
          <li class="nav-item">
            <a class="nav-link" href="entitiesList.php">Entities List</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="categoryList.php">Categoris List</a>
          </li>
          <li class="nav-item">
